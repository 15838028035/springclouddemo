package com.lj.cloud.weixin.constant;

public class SecrityCommonConstant {
    ...
    public static final String FILE_UPLOAD_PREFIX = "file";
    
    public static final String FILE_UPLOAD_DIR = "d:\\dev\\upload";//文件上传目录
